...
export default function HomeView({ location }: HomeViewProps) {
  ...
  const coordinates = locationCoordinates[location.toLowerCase()] || locationCoordinates['montalban'];
  const lguPage = lguFacebookPages[location.toLowerCase()] || lguFacebookPages['montalban'];
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {/* FIX: Conditionally render the LGU Announcements card */}
      {location.toLowerCase() === 'montalban' && (
